    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24">
        ...
        <div className="flex items-center font-medium mt-6">
          <Link
            to={"/products"}
            className="group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary hover:bg-primary-dull transition rounded text-white cursor-poiter">
            Shop now
            <img
          ...
          <Link
            to={"/products"}
            className="group hidden md:flex items-center gap-2 md:px-9 py-3 cursor-poiter">
            Explore deals
            <img
